...
export default function EditarLancamentoPage() {
  ...
  useEffect(() => {
    const fetchOptions = async () => {
      try {
        ...
        // Adicionado filtro de is_active=true para trazer apenas dados ativos na edição
  ...
  const fields: FormFieldDef[] = useMemo(() => [
    ...
    { field: 'description', label: 'Descrição', type: 'text', required: true, className: 'col-span-full' },
    { 
      field: 'amount', 
      label: 'Valor', 
      type: 'text', 
