    ...
    return [
      ...
      },
      {
        ...
        fields: [
          ...
          { field: 'rent_due_day', label: 'Vencimento Aluguel', type: 'text', required: true, placeholder: 'Dia 5', icon: <Calendar size={20} /> },
          { field: 'tax_due_day', label: 'Vencimento IPTU', type: 'text', placeholder: 'Dia 10', icon: <Calendar size={20} /> },
          { field: 'condo_due_day', label: 'Vencimento Condomínio', type: 'text', placeholder: 'Dia 10', icon: <Calendar size={20} /> },
        ],
      },
      {
